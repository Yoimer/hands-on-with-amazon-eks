...
# Get the Repositories' URLs
    inventory_api_repo_url=$(aws cloudformation describe-stacks --stack inventory-api-codecommit-repo --query "Stacks[*].Outputs[?OutputKey=='CloneUrlSsh'].OutputValue" --output text | xargs)
    resource_api_repo_url=$(aws cloudformation describe-stacks --stack resource-api-codecommit-repo --query "Stacks[*].Outputs[?OutputKey=='CloneUrlSsh'].OutputValue" --output text | xargs)
    renting_api_repo_url=$(aws cloudformation describe-stacks --stack renting-api-codecommit-repo --query "Stacks[*].Outputs[?OutputKey=='CloneUrlSsh'].OutputValue" --output text | xargs)
    clients_api_repo_url=$(aws cloudformation describe-stacks --stack clients-api-codecommit-repo --query "Stacks[*].Outputs[?OutputKey=='CloneUrlSsh'].OutputValue" --output text | xargs)
    front_end_repo_url=$(aws cloudformation describe-stacks --stack front-end-codecommit-repo --query "Stacks[*].Outputs[?OutputKey=='CloneUrlSsh'].OutputValue" --output text | xargs)
